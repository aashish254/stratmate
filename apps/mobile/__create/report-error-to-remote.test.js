...
beforeEach(() => {
  ...
  delete process.env.EXPO_PUBLIC_APP_ID;
  delete process.env.EXPO_PUBLIC_LOGS_API_KEY;
...
describe('sendLogsToRemote', () => {
  ...
  it('sends logs to the endpoint with correct auth header', async () => {
    ...
    process.env.EXPO_PUBLIC_APP_ID = 'pg-123';
    process.env.EXPO_PUBLIC_LOGS_API_KEY = 'key-abc';
